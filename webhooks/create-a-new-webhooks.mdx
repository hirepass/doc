...
description: "When important changes happen, like new requests or status updates, Source Compliant sends notifications to a web address you choose. This means you don't need to keep checking the system manually."
---
...
After completing the setup, test your webhook endpoint. This will ensure you're properly receiving the data from Source Compliant. To test the webhook connection, click on "Test connection", and a placeholder test will be sent to your URL.
