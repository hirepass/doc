...
Once your account has been [authenticated](/o/JYWEf8noJAYpEY9XONdS/s/XqNcncLPbRfoQWzDqCVx/~/changes/8/graphql-api/api-authentication-key), it’s time to build your first GraphQL query\!
...
Ready to get started? Head over [API key](/o/JYWEf8noJAYpEY9XONdS/s/XqNcncLPbRfoQWzDqCVx/~/changes/8/graphql-api/api-authentication-key) for your credentials and then to the [GraphQL playground](https://sourcecomplaint.com) where you can write and test queries in real time.