...
Once your account has been [authenticated](https://docs.hirepass.com/graphql/api-authentication-key), it’s time to build your first GraphQL query\!
...
Ready to get started? Head over [API key](https://docs.hirepass.com/graphql/api-authentication-key) for your credentials and then to the [GraphQL playground](https://graphql.hirepass.com) where you can write and test queries in real time.