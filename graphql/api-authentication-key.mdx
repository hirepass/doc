...
1. **Set up your test environment** Use a test environment using the [GraphQL playground.](https://studio.apollographql.com/public/hirepass/variant/current/home)
